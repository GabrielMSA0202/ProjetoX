...
void CadastrarMembro(int pos){
    ...
    for (int i = 0; i < strlen(projetox[pos]->Nome); ++i) {
        if (*p_Nome == '0' || *p_Nome == '1' || *p_Nome == '2' || *p_Nome == '3' || *p_Nome == '4' || *p_Nome == '5' || *p_Nome == '6'
        ...
        if (Verificador == 1) {
            ...
            switch (opcao) {
                case 1:
                    ...
                    break;
                case 2:
                    if (projetox[GuardarPosicao]->Reserva == 0){
                        printf("\n\t\t\t\t\t\t\t|VOCE NAO TEM NENHUMA RESERVA             |");
                        printf("\n\t\t\t\t\t\t\t|                                         |");
                        printf("\n\t\t\t\t\t\t\t|VOLTANDO AO MENU.....                    |");
                        printf("\n\t\t\t\t\t\t\t|_________________________________________|\n\n");
                    } else{
